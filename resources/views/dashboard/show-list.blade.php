                            ...
                            <div class="col-md-4" style="padding-top: 50px;">
                                <div class="configration">    
                                    <ul class="nav nav-tabs nav-justified">
                                        ...
                                        <li class="config"><a href="#tab9" data-toggle="tab" rel = "bugs" aria-expanded="false">Bug Configration</a></li>
                                    </ul>
                                </div>  
                                            ...
                                            <a href="javascript:void(0)" class="list-group-item {{$list['checklist_enable'] ? 'active':''}}">
                                                <span class="add_hook">
                                                    <div id="_{{$list['trello_list_id']}}" class="list-group-status  status-{{ ($list['checklist_enable'] ? 'online':'offline') }}"></div>
                                                        ...
                                                        @endif   
                                                        <input style="display:none;" type="radio"   {{( $list['checklist_enable']  ? 'checked':'')}} name="list_id" value="{{$list['trello_list_id']}}~{{$list['trello_board_id']}}">
                                                    </div>
                                                </span>
