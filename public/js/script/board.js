    ...
    $(document.body).on("click", "._register", function() {
                ...
                if (willDelete) {
                    ...
                    remove_hook(status, board_id)
                        .then(() => {
                            ...
                            _this.html(
                                'Enable Report <i class="fa fa-spinner fa-spin icon_show" style="display:none;" aria-hidden="true"></i>'
                            );
                        })
                        .catch(() => {
                            $(this)
        ...
        reqgister(status, board_id)
            .then(() => {
                ...
                _this.html(
                    'Disable Report <i class="fa fa-spinner fa-spin icon_show" style="display:none;" aria-hidden="true"></i>'
                );
            })
            .catch(() => {
                $(this)
